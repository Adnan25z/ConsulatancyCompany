...
import com.orax.consultantcompany.session.UsersFacade;
...
public class UsersController implements Serializable {
    ...
    @EJB
    private com.orax.consultantcompany.session.UsersFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            current.setPassword(JsfUtil.sha256(password));
...
//            return prepareCreate();
    ...
    public SelectItem[] getRecruiters() {
        return JsfUtil.getSelectItems(ejbFacade.getAllRecruiters(), true);
    }

    public SelectItem[] getConsultants() {
        return JsfUtil.getSelectItems(ejbFacade.getAllConsultants(), true);
    }
